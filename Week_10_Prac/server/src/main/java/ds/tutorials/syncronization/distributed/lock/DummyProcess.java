package ds.tutorials.syncronization.distributed.lock;
...
public class DummyProcess {
    ...
    public static void main(String[] args) { DistributedLock.setZooKeeperURL(ZOOKEEPER_URL);
        try {
    ...
    private static void accessSharedResource() throws InterruptedException {
        Random r = new Random();
        long sleepDuration = Math.abs(r.nextInt() % 20); System.out.println("Accessing critical section. Time remaining : " + sleepDuration + " seconds."); Thread.sleep(sleepDuration * 1000);
    }
